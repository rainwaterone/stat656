...
p     = n_int  # Total number of features 60
...
calcModel  = models [0]
goodFit    = fitness[0]
initMethod = init[1] #Initial generation has only 1 feature per individual.
...
n       = y.shape[0]
p       = len(header)
k       = p + 2 #plus intercept and sigma]
R2      = r2_score(y, proba)
adjr2   = 1.0-R2 
adjr2   = ((n-1)/(n-p-1))*adjr2
adjr2   = 1.0 - adjr2
